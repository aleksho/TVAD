...
DIR_WORK = '/mnt/disk1/alexander_nn/work'
# DIR_WORK = f'{DIR_HOME}/work'
# os.chdir(DIR_WORK)
# DIR_IMAGE_TRAIN =f'{DIR_HOME}/dir_images'
...
dir:
    ...
    train_file    : '{dir_datas}/train_file.csv'
    val_file      : '{dir_datas}/val_file.csv'
    test_file     : '{dir_datas}/test_file.csv'
    predict_file  : '{dir_datas}/predict_file.csv'
    ...
    input_file : '{dir_datas}/input_file.csv'
    output_file: '{dir_datas}/output_file.csv'
